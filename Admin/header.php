...
<body>
 ...
 <li>
                <a href="liste_client.php"> <i class="fa fa-user"></i>Gerer Client</a>
                 </li>
                  ...
                  <li>
                        <a href="reclamation.php"><i class="fa fa-edit"></i> Gerer   Réclamation</a>
                    </li>

                     <li>
                        <a href="demande.php"><i class="fa fa-list"></i> Gerer   Demande</a>
                    </li>
